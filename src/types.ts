...
import { ParamsDict, PathParams } from './processors/HttpProcessor';
...
export type Request<
  TPath extends string = string,
  RBdy extends Record<string, unknown> | null = null,
  TBody extends Record<string, unknown> | null = null,
  TQuery extends Record<string, unknown> | null = null,
  TLocals extends Record<string, any> = Record<string, any>
> = import('express').Request<ParamsDict<TPath>, RBdy, TBody, TQuery, TLocals>;
